...
let vocabularyLevels: [VocabularyLevel] = [
    ...
    VocabularyLevel(id: "N2", name: "Pre-Advanced", description: "1.112 Kosakata Lanjutan", color: AppTheme.levelColor("N2"), bgColor: AppTheme.levelBackground("N2"), isLocked: true, jsonFile: "VocabN2"),
