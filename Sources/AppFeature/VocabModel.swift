...
let vocabularyLevels: [VocabularyLevel] = [
    ...
    VocabularyLevel(id: "N3", name: "Intermediate", description: "1.370 Kosakata Menengah", color: AppTheme.levelColor("N3"), bgColor: AppTheme.levelBackground("N3"), isLocked: false, jsonFile: "VocabN3"),
