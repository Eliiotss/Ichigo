...
final class JSONResourceCache {
    ...
    private func resolveResourceURL(filename: String) -> URL? {
        ...
        // `.module` is the resource bundle generated by SwiftPM for this target and
        // is the canonical location for the datasets; the remaining bundles are a
        // defensive fallback for other packaging setups.
        var candidates: [Bundle] = [.module, .main, Bundle(for: BundleFinder.self)]
