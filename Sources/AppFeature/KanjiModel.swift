...
let jlptLevels: [JLPTLevel] = [
    ...
    JLPTLevel(id: "N3", name: "Intermediate", description: "238 Essential Kanji", color: AppTheme.levelColor("N3"), bgColor: AppTheme.levelBackground("N3"), isLocked: false, jsonFile: "KanjiN3"),
