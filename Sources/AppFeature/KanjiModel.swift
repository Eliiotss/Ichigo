...
let jlptLevels: [JLPTLevel] = [
    ...
    JLPTLevel(id: "N3", name: "Intermediate", description: "367 Essential Kanji", color: AppTheme.levelColor("N3"), bgColor: AppTheme.levelBackground("N3"), isLocked: false, jsonFile: "KanjiN3"),
    JLPTLevel(id: "N2", name: "Pre-Advanced", description: "118 Complex Kanji", color: AppTheme.levelColor("N2"), bgColor: AppTheme.levelBackground("N2"), isLocked: true, jsonFile: "KanjiN2"),
