...
let jlptLevels: [JLPTLevel] = [
    ...
    JLPTLevel(id: "N2", name: "Pre-Advanced", description: "247 Complex Kanji", color: AppTheme.levelColor("N2"), bgColor: AppTheme.levelBackground("N2"), isLocked: true, jsonFile: "KanjiN2"),
