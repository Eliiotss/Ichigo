...
final class JSONResourceCache {
    ...
    private func resolveResourceURL(filename: String) -> URL? {
        ...
        // Search the main app bundle first (Swift Playgrounds and app builds put
        // processed resources there), then the framework bundle for this module,
        // then everything else as a defensive fallback. `Bundle.module` is not used
        // because it is not available in the Swift Playgrounds build system.
