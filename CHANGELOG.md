...
- **65 verified N3 kanji** (`KanjiN3.json`, `N3_215`–`N3_279`), added in themed
  clusters — economy/money (富, 貧, 貸, 貨, 貯, 販, 換, 略 …), nature/water (波, 岸,
  河, 岩, 砂, 灰, 煙, 湖, 沿, 傾, 沈, 浮, 潮), body/health (胸, 腹, 肩, 腰, 髪, 涙, 汗,
  呼, 眠, 疲, 痛, 症, 骨, 傷) and emotion/mind (怒, 悲, 喜, 恐, 怖, 恥, 恋, 慣, 憶, 惑,
  悩, 忙, 忘, 慎) — all common kanji not already in any level. Each carries accurate
  ...
  furigana + Indonesian). The level count in `KanjiModel.swift` moves 214 → 279,
