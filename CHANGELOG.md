...
- **49 kanji from the study material added at their proper JLPT level (Android).**
  ...
  **N4 +11** (自, 道, 親, 頭, 元, 回, 数, 止, 仕, 画, 算), **N3 +23** (業, 直, 真,
  ...
  - **Batch 4 (+74).** **N4 +9** (辺, 米, 私, 星, 鼻, 列, 王, 遊, 酒), **N3 +27**
    (燃, 敗, 庫, 善, 警, 笑, 災, 句, 基, 派, 杯, 掃, 像, 編, 司, 迎, 典, 軍, 謝, 鳴,
    各, 周, 街, 標, 談, 版, 矢), **N2 +30** (就, 干, 被, 刻, 射, 坊, 免, 柄, 援, 酸,
    革, 巻, 誤, 溶, 暴, 筋, 添, 激, 敬, 仮, 頂, 興, 照, 滞, 乱, 募, 概, 源, 精, 肥)
    and the **first 8 N1-level kanji** (遣, 焦, 露, 滅, 塵, 亜, 摘, 懐) begin a new
    `KanjiN1.json`. Counts move to **137 / 233 / 482 / 320** (N5–N2). The N1 Kanji
    level stays **locked** while its file accumulates across batches; it is
    unlocked in one go once it holds a full set.
  - **Batch 5 (+78).** **N4 +3** (晩, 第, 絵), **N3 +31** (衛, 測, 帳, 衣, 宿, 枝,
    筆, 婦, 刊, 頼, 戻, 普, 背, 救, 景, 了, 毒, 歴, 預, 底, 丁, 栄, 板, 承, 候, 歳,
    宝, 権, 群, 濯, 浴), **N2 +40** (郷, 跡, 栽, 著, 操, 推, 裁, 培, 凍, 覧, 蒸, 灯,
    沢, 腕, 納, 慢, 妙, 致, 厳, 敷, 勘, 為, 依, 刺, 従, 幼, 志, 殊, 繁, 滑, 拝, 豪,
    埋, 勧, 潔, 封, 縦, 尊, 釣, 劇) and **N1 +4** (膨, 剥, 擦, 鈍). Counts move to
    **137 / 236 / 513 / 360** (N5–N2); the locked `KanjiN1.json` now holds 12.
  - **Batch 6 (+75).** **N5 +1** (鳥), **N4 +9** (英, 羽, 湯, 玉, 低, 努, 晴, 島,
    億), **N3 +24** (季, 暖, 祝, 官, 郵, 児, 簡, 殺, 探, 床, 武, 裏, 希, 訪, 閉, 久,
    純, 厚, 則, 益, 般, 旧, 陸, 浅), **N2 +32** (療, 看, 棚, 瓶, 蔵, 衆, 姿, 敵, 魔,
    攻, 震, 秘, 薄, 鹿, 慮, 扱, 怪, 偶, 柔, 抗, 爆, 脱, 崩, 房, 遺, 眼, 浸, 創, 兼,
    寿, 奇, 催) and **N1 +9** (苗, 緒, 闇, 尻, 怠, 紛, 逸, 躍, 如). Counts move to
    **138 / 245 / 537 / 392** (N5–N2); the locked `KanjiN1.json` now holds 21.
  - **Batch 7 (+75).** **N5 +1** (村), **N4 +9** (京, 走, 静, 窓, 猫, 寒, 雪, 庭,
    雲), **N3 +19** (棒, 乳, 績, 属, 祖, 亡, 航, 豊, 炭, 夢, 届, 影, 功, 紹, 責, 条,
    犯, 鏡, 述), **N2 +34** (刑, 朗, 策, 熟, 幹, 炊, 梅, 幾, 缶, 酔, 腐, 紅, 零, 殿,
  ...
  - **Batch 9 (+72).** **N4 +5** (菜, 倍, 黄, 県, 枚), **N3 +14** (恩, 匹, 脳, 委,
    堂, 飼, 序, 副, 泉, 仏, 倉, 誌, 氏, 博), **N2 +32** (漫, 称, 唱, 促, 却, 仰, 雇,
    拍, 蓄, 淡, 核, 烈, 噴, 搬, 献, 揚, 陶, 諸, 冒, 猿, 飽, 卓, 甲, 宗, 駐, 雷, 奈,
    浜, 筒, 項, 避, 敏) and **N1 +21** (惚, 噛, 萎, 寛, 籠, 堪, 膚, 鬱, 艶, 纏, 粋,
    羅, 緯, 償, 偽, 爽, 瀬, 旦, 馳, 喧, 翻). Counts move to **140 / 266 / 588 / 493**
    (N5–N2); the locked `KanjiN1.json` now holds 69.
  - **Batch 10 (+74).** **N4 +5** (貝, 畑, 豆, 誰, 氷), **N3 +9** (脈, 柱, 銅, 隣,
    娘, 城, 史, 踊, 詩), **N2 +31** (泡, 歓, 粧, 奏, 稲, 乙, 還, 皇, 磁, 軟, 妥, 庁,
    召, 穫, 輩, 黙, 眺, 挨, 拶, 椅, 奮, 剣, 衝, 臓, 択, 将, 隅, 括, 尾, 稿, 胆) and
    **N1 +28** (埃, 蜜, 贅, 眉, 阿, 卸, 暦, 錯, 壌, 凄, 襲, 奪, 麗, 悟, 噂, 魂, 褒,
    捲, 顧, 繋, 弄, 縛, 嫉, 妬, 煩, 嗜, 邸, 湧). Counts move to **141 / 271 / 597 /
    524** (N5–N2); the locked `KanjiN1.json` now holds 97.
  - **Batch 11 (+73).** **N4 +2** (谷, 孫), **N3 +4** (忠, 墓, 臣, 旗), **N2 +27**
    (把, 臨, 肪, 己, 漠, 肺, 剤, 挑, 架, 抽, 伴, 兆, 猛, 伏, 妨, 彫, 嫁, 泥, 需, 貼,
    肝, 彩, 肌, 凡, 朴, 盾, 稚) and **N1 +40** (嵩, 昧, 叶, 弊, 捗, 遜, 煌, 陥, 鍛,
  ...
  - **Batch 12 (+70).** **N5 +1** (糸), **N4 +1** (寺), **N3 +6** (舎, 胃, 豚, 賀,
    誕, 童), **N2 +19** (宙, 俳, 渇, 湾, 墨, 班, 鉛, 帽, 沖, 縄, 涼, 銭, 稼, 裸, 患,
    逮, 魅, 雄, 殻) and **N1 +43** (疹, 俯, 箋, 躊, 躇, 轢, 蒔, 凸, 醤, 漬, 蓋, 玩,
