...
- **260 verified N3 vocabulary entries** (`VocabN3.json`, `N3_V1111`–`N3_V1370`),
  ...
  申請, 頻度, 単調, 過度, 相次いで, 次々, とっくに). Each carries an accurate reading,
  Indonesian meaning and word type; the level count advertised in
  `VocabModel.swift` moves 1.110 → 1.370 and stays enforced by
