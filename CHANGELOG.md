...
- **79 verified N3 kanji** (`KanjiN3.json`, `N3_215`–`N3_293`), added in themed
  ...
  融, 株, 債, 僚) — all common kanji not already in any level. Each carries accurate
  ...
  furigana + Indonesian). The level count in `KanjiModel.swift` moves 214 → 293,
